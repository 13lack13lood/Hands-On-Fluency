...
const HomePage = ({ setDisplay }) => {
    return (
        <div className="flex flex-col justify-evenly items-center m-10 space-y-10 h-full">
            ...
            <LessonPreview buttonText="Lesson 2" description="Learn the common phrases in sign language" completed={false} setDisplay={setDisplay} number={2}></LessonPreview>
            <LessonPreview buttonText="Lesson 3" description="Learn the common words and improve vocabulary in sign language" completed={false} setDisplay={setDisplay} number={3}></LessonPreview>
        </div>
    );
};
